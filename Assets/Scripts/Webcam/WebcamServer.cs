...
*   @author     : 	Ivan Granic, Mike Hilts, Jason Kassies, Div Dankahara
*   @date       : 	2021-03-27
*   @brief      : 	This file contains the WebcamServer class and sends the data
*/
...
/*! <summary>
*  This file contains the WebcamServer class which is responsible for starting the
...
public class WebcamServer : MonoBehaviour
{
    ...
    /*! <summary>
     *  Called before the first frame. This will ensure it is the performeruser, initialize fields,
     *  start the webcam, send the webcam event to photon network and start the webcam server.
     *  </summary>
    ...
    /*! <summary>
     *  Called once per frame. This will check if the camera updated this frame
    ...
    /*! <summary>
     *	Called when this is destroyed. Will close and open connections and abort any
     *	running threads and close the server.
     *  </summary>
     *  <param name="none"></param>
     *  <returns>void</returns>
     */
    ...
    /*! <summary>
     *  Called when this is application is closed. Will close and open connections
     *  and abort any running threads and close the server.
     *  </summary>
     *  <param name="none"></param>
     *  <returns>void</returns>
     */
    ...
    /*! <summary>
     *  Used to start the webcam. It will instantiate a webcam texture, get reference to the
    ...
    /*! <summary>
     *  This is used to send an event to the photon network with the servers ip and port,
     *  as well as the height and width of the image. Any client that joins the room
     *  will get the event and use it to connect to this server.
     *  </summary>
     *  <param name="none"></param>
     *  <returns>void</returns>
     */
    ...
    /*! <summary>
     *  This is used to instantiate the server and start it. It will then begin
    ...
    /*! <summary>
     *  This will run on a seperate thread and will listen for new clients who connect to this server.
     *  For each client that connects it will begin a client thread to handle sending them the frame data.
     *  </summary>
     *  <param name="none"></param>
     *  <returns>void</returns>
     */
    ...
    /*! <summary>
     *  This method will send two messages to the connected client for each webcam frame update.
     *  The first is the size of the image captured and the second is the captured
     *  image as a byte array.
     *  </summary>
     *  <param name="_data">the client that will be run on this thread.</param>
     *  <returns>void</returns>
     */
    ...
    /*! <summary>
     *  Will close and open connections and abort any running threads and close the server.
     *  </summary>
     *  <param name="none"></param>
     *  <returns>void</returns>
     */
